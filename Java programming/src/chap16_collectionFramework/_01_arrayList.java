...
public class _01_arrayList {
	...
	public static void main(String[] args) {
		...
		list2 = new ArrayList(list1.subList(2,  5));  //2번 인덱스부터 5번 인덱스 전까지
		//print(println, printf...)의 매개변수로 객체를 넣게 되면 자동으로 toString()메소드가 실행된 결과가 출력된다.
		...
		//list2 데이터 추가
		list2.add("collection");   //object형태이기에 int, String형 모두 가능.
		list2.add("framework");
		System.out.println(list2);
