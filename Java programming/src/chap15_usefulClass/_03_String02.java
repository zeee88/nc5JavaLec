...
public class _03_String02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(intArr.length);    //length가 속성 값
		System.out.println("str1의 길이는 " + str1.length() + "입니다. ");  //length가 메소드
		...
		System.out.println(str4.replaceAll("[ac]", "2"));  //[]안의 문자를 전부 치환.
		System.out.println(str4.replace('a', '1'));
		//체이닝 기법. 
		System.out.println(str4.replace('b', '2'));
		System.out.println(str4.replace('c', '3'));
