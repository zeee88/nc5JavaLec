...
public class BoardDAOJdbcDaoSupport extends JdbcDaoSupport {
	...
	public void insertBoard(BoardDTO boardDTO) {
		...
		getJdbcTemplate().update(INSERT_BOARD, boardDTO.getBoardTitle(), boardDTO.getBoardContent(), boardDTO.getBoardWriter());
	}
	...
	public void updateBoard(BoardDTO boardDTO) {
		...
		getJdbcTemplate().update(UPDATE_BOARD, boardDTO.getBoardTitle(), boardDTO.getBoardContent(), boardDTO.getBoardNo());
	}
	...
	public BoardDTO getBoard(int boardNo) {
		...
		return getJdbcTemplate().queryForObject(GET_BOARD, args, new BoardRowMapper());
	}
