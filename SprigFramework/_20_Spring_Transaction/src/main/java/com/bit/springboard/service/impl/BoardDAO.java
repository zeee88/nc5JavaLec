...
public class BoardDAO {
	...
	public void insertBoard(BoardDTO boardDTO) {
		...
		jdbcTemplate.update(INSERT_BOARD, boardDTO.getBoardNo(), boardDTO.getBoardTitle(), boardDTO.getBoardContent(), boardDTO.getBoardWriter());
	}
	...
	public void updateBoard(BoardDTO boardDTO) {
		...
		jdbcTemplate.update(UPDATE_BOARD, boardDTO.getBoardTitle(), boardDTO.getBoardContent(), boardDTO.getBoardNo());
	}
