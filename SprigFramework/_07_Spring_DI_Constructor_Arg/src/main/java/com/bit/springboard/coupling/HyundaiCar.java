...
public class HyundaiCar implements Car{
	...
	public HyundaiCar(CarAudio carAudio) {
		...
		System.out.println("HyundaiCar CarAudio 파리미터 생성자 호출");
	...
	public HyundaiCar(CarAudio carAudio, String model) {
		...
		this.carAudio = carAudio;
		//현대카 객체가 생성되면서 현대카 안의 carAudio변수는 초기화(객체가 주입, 의존성이 주입)가 된 상태
		this.model = model;
		System.out.println("HyundaiCar CarAudio, Model 파리미터 생성자 호출");
	}
