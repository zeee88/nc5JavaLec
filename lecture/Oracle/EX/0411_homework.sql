...
--4) 학과별 학년별로 학생의 정보를 성적순(성적이 높은 순)으로 검색하라
SELECT *
    FROM STUDENT
...
SELECT *
    FROM PROFESSOR
    ORDER BY ORDERS;
--8) 각 학과별로 교수의 정보를 부임일자(오래된 순) 순으로 검색하라
SELECT *
    FROM PROFESSOR
