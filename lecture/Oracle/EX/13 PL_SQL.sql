...
BEGIN
    ...
    --EXISTS 함수는 TRUE/FALSE 를 리턴하기 때문에 출력하는 매개변수로 사용불가
    --IF나 CASE 조건절에 사용한다.
    ...
    IF STUARR.EXISTS(3) THEN
        DBMX_OUTPUT.PUT_LINE('3번 INDEX 있음');
    ELSE
        DBMX_OUTPUT.PUT_LINE('3번 INDEX 없음');
    END IF;
