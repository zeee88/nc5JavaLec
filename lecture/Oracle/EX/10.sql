...
--STUDENT의 SNO, SNAME, MAJOR  / SCORE의 RESULT / SCGRADE의 GRADE 가지는 테이블 생성
CREATE TABLE SCORE_GRADE1(SNO, SNAME, MAJOR, RESULT, GRADE)
    AS SELECT SNO
            , ST.SNAME
            , ST.MAJOR
            , SC.RESULT
...
--EMP_COPY 테이블의 ENO컬럼의 데이터 타입을 VARCHAR2(4) -> VARCHAR2(10)
ALTER TABLE EMP_COPY
